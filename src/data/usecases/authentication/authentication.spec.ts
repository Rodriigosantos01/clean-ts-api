...
import { AccountModel, LoadAccountByEmailRepository, AuthenticationModel, HashComparer, UpdateAccessTokenRepository, Encrypter } from "./db-authentication-protocols";
