...
import { AccountModel, LoadAccountByEmailRepository, AuthenticationParams, HashComparer, UpdateAccessTokenRepository, Encrypter } from "./db-authentication-protocols";
